...
public class PageVisitRepoTest {
    ...
    final PageVisit user1page2Yesterday = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(1L)).build();
    final PageVisit user1page3Yesterday = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(1L)).build();
    final PageVisit user1page4Yesterday = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(1L)).build();
    final PageVisit user1page5Yesterday = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(1L)).build();
    final PageVisit user1page6Yesterday = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(1L)).build();
    final PageVisit user1page7Yesterday = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(1L)).build();
    final PageVisit user1page8Yesterday = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(1L)).build();
    final PageVisit user1page9Yesterday = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(1L)).build();
    ...
    final PageVisit user1page2TwoDaysAgo = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(2L)).build();
    final PageVisit user1page3TwoDaysAgo = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(2L)).build();
    final PageVisit user1page4TwoDaysAgo = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(2L)).build();
    final PageVisit user1page5TwoDaysAgo = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(2L)).build();
    final PageVisit user1page6TwoDaysAgo = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(2L)).build();
    final PageVisit user1page7TwoDaysAgo = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(2L)).build();
    final PageVisit user1page8TwoDaysAgo = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(2L)).build();
    final PageVisit user1page9TwoDaysAgo = PageVisit.builder().userId(1L).pageId(1L).visitDate(LocalDateTime.now().minusDays(2L)).build();
    ...
    final PageVisit user3page4WeekAgo = PageVisit.builder().userId(3L).pageId(3L).visitDate(LocalDateTime.now().minusWeeks(1L)).build();
    final PageVisit user3page5WeekAgo = PageVisit.builder().userId(3L).pageId(3L).visitDate(LocalDateTime.now().minusWeeks(1L)).build();
    final PageVisit user3page6WeekAgo = PageVisit.builder().userId(3L).pageId(3L).visitDate(LocalDateTime.now().minusWeeks(1L)).build();
    final PageVisit user3page7WeekAgo = PageVisit.builder().userId(3L).pageId(3L).visitDate(LocalDateTime.now().minusWeeks(1L)).build();
    final PageVisit user3page8WeekAgo = PageVisit.builder().userId(3L).pageId(3L).visitDate(LocalDateTime.now().minusWeeks(1L)).build();
    final PageVisit user3page9WeekAgo = PageVisit.builder().userId(3L).pageId(3L).visitDate(LocalDateTime.now().minusWeeks(1L)).build();
    final PageVisit user3page10WeekAgo = PageVisit.builder().userId(3L).pageId(3L).visitDate(LocalDateTime.now().minusWeeks(1L)).build();
    final PageVisit user3page11WeekAgo = PageVisit.builder().userId(3L).pageId(3L).visitDate(LocalDateTime.now().minusWeeks(1L)).build();
    ...
    void getRegularVisitByPeriod_WhenNotEnoughVisitsInPeriod_ThenReturn_0() {
        ...
        repo.save(user3page3MonthAgo);
        assertEquals(15, repo.count());
        assertEquals(0, repo.getRegularVisitByPeriod(LocalDateTime.now().minusWeeks(2L),LocalDateTime.now().minusDays(1L)));
    }
